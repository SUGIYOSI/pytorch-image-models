...
python -m torch.distributed.launch --nproc_per_node=$NUM_PROC train.py ./ \
    ...
    --log-wandb \
    --output train_result \
    --experiment Test_Finetuning_vit_deit_tiny_patch16_224_default-imnet1k_to_CIFAR100 \
    --id_wandb Test_Finetuning_vit_deit_tiny_patch16_224_default-imnet1k_to_CIFAR100 \
    -j 4
